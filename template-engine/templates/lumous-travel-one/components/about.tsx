    ...
    <section id="about" data-reveal className="py-[clamp(88px,11vw,180px)]">
      ...
      >
        <div className="flex flex-col justify-between gap-[clamp(40px,8vw,120px)]">
          ...
          <p className="font-lt-label text-lt-xs text-lt-muted-foreground m-0 max-w-[46ch] leading-[1.9] font-extralight tracking-[0.06em] uppercase">
            {trimmed(content.aboutIntro)}
          </p>
        </div>
        <div className="flex flex-col gap-[clamp(28px,3vw,44px)]">
          <h2 className="font-lt-display text-lt-display-md text-lt-foreground/[0.58] m-0 leading-[1.02] font-extralight tracking-[-0.04em] text-pretty">
